...
import { CoreWebSocketProvider } from './contexts/CoreWebSocketContext';
import { SubmissionWebSocketProvider } from './contexts/SubmissionWebSocketContext';

const App = () => (
  <Router>
    <AuthProvider>
      <CoreWebSocketProvider>
        <SubmissionWebSocketProvider>
          <AppConfigProvider>
            <Routes>
